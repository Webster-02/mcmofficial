(function(){
  function renderStudent(){
    ...
    app.innerHTML=`<main class="student-page">
      <section class="student-hero"><div><h1>Student Dashboard</h1><p>Welcome back. Here is your assigned class information.</p></div><span class="student-badge">Student Portal</span></section>
      ...
      <div class="student-actions"><a href="#timetable">View Timetable</a><a href="#notes" class="secondary">Open Notes</a><a href="#discussions" class="secondary">Class Community</a><a href="#attendance" class="secondary">Attendance</a><a href="#login" class="secondary">Switch Role</a></div>
    </main>`;
  }
